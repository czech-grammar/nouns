// Topic: shopping
WORDS.push(
  { cs: 'koruna', en: 'crown (money)', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
  ...
  { cs: 'cena', en: 'price', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
  ...
  { cs: 'peněženka', en: 'wallet', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
  ...
  { cs: 'taška', en: 'bag', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
  ...
  { cs: 'pokladna', en: 'checkout, till', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
  ...
  { cs: 'karta', en: 'card', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
  ...
  { cs: 'banka', en: 'bank', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
  ...
  { cs: 'pošta', en: 'post office', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
  ...
  { cs: 'lékárna', en: 'pharmacy', pattern: 'žena', gender: 'f', level: 'A1', topic: 'shopping', svg: `
