// Topic: school (neuter)
WORDS.push(
  { cs: 'slovo', en: 'word', pattern: 'město', gender: 'n', topic: 'school', svg: `
  ...
  { cs: 'číslo', en: 'number', pattern: 'město', gender: 'n', topic: 'school', svg: `
  ...
  { cs: 'písmeno', en: 'letter (of the alphabet)', pattern: 'město', gender: 'n', topic: 'school', svg: `
  ...
  { cs: 'pero', en: 'pen', pattern: 'město', gender: 'n', topic: 'school', svg: `
  ...
  { cs: 'cvičení', en: 'exercise', pattern: 'stavení', gender: 'n', topic: 'school', svg: `
  ...
  { cs: 'zaměstnání', en: 'job, employment', pattern: 'stavení', gender: 'n', topic: 'school', svg: `
  ...
  { cs: 'povolání', en: 'profession', pattern: 'stavení', gender: 'n', topic: 'school', svg: `
