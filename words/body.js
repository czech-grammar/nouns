// Topic: body
WORDS.push(
  { cs: 'noha', en: 'leg, foot', pattern: 'žena', gender: 'f', level: 'A1', official: null, topic: 'body', svg: `
  ...
  { cs: 'pusa', en: 'mouth', pattern: 'žena', gender: 'f', level: 'A1', official: null, topic: 'body', svg: `
  ...
  { cs: 'kost', en: 'bone', pattern: 'kost', gender: 'f', level: 'A1', official: 'A2', topic: 'body', svg: `
  ...
  { cs: 'nemoc', en: 'illness', pattern: 'kost', gender: 'f', level: 'A1', official: 'A1', topic: 'body', svg: `
  ...
  { cs: 'bolest', en: 'pain', pattern: 'kost', gender: 'f', level: 'A1', official: 'A2', topic: 'body', svg: `
  ...
  { cs: 'chřipka', en: 'flu', pattern: 'žena', gender: 'f', level: 'A1', official: 'A1', topic: 'body', svg: `
  ...
  { cs: 'brýle', en: 'glasses', pattern: 'plural only', gender: 'f', level: 'A1', official: 'A1', topic: 'body', svg: `
