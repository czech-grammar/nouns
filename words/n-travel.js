// Topic: travel (neuter)
WORDS.push(
  { cs: 'moře', en: 'sea', pattern: 'moře', gender: 'n', level: 'A1', official: 'A1', topic: 'travel', svg: `
  ...
  { cs: 'slunce', en: 'sun', pattern: 'moře', gender: 'n', level: 'A1', official: 'A1', topic: 'travel', svg: `
  ...
  { cs: 'nebe', en: 'sky', pattern: 'moře', gender: 'n', level: 'A1', official: 'A2', topic: 'travel', svg: `
  ...
  { cs: 'pole', en: 'field', pattern: 'moře', gender: 'n', level: 'A1', official: 'A2', topic: 'travel', svg: `
    <circle cx="20" cy="18" r="10" fill="#f9c74f" ${S}/>
  ...
  { cs: 'jezero', en: 'lake', pattern: 'město', gender: 'n', level: 'A1', official: 'A2', topic: 'travel', svg: `
