// Topic: food
WORDS.push(
  { cs: 'káva', en: 'coffee', pattern: 'žena', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'polévka', en: 'soup', pattern: 'žena', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'ryba', en: 'fish', pattern: 'žena', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'zelenina', en: 'vegetables', pattern: 'žena', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'mrkev', en: 'carrot', pattern: 'píseň', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'brambora', en: 'potato', pattern: 'žena', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'cibule', en: 'onion', pattern: 'růže', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'zmrzlina', en: 'ice cream', pattern: 'žena', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'čokoláda', en: 'chocolate', pattern: 'žena', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'rýže', en: 'rice', pattern: 'růže', gender: 'f', level: 'A1', topic: 'food', svg: `
  ...
  { cs: 'sůl', en: 'salt', pattern: 'kost', gender: 'f', level: 'A1', topic: 'food', svg: `
