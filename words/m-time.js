...
WORDS.push(
  { cs: 'čas', en: 'time', pattern: 'hrad', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'den', en: 'day', pattern: 'hrad (dne)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'týden', en: 'week', pattern: 'hrad (týdne)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'rok', en: 'year', pattern: 'hrad', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'večer', en: 'evening', pattern: 'hrad', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'čtvrtek', en: 'Thursday', pattern: 'hrad (čtvrtka)', gender: 'mi', topic: 'time', svg: `
    <rect x="6" y="22" width="108" height="72" rx="6" fill="#fff" ${S}/>
    <path d="M6 28 a6 6 0 0 1 6 -6 h96 a6 6 0 0 1 6 6 v6 H6 Z" fill="#4fa3e3" ${S}/>
    <rect x="34" y="14" width="6" height="16" rx="3" fill="#7a7f87" ${S}/>
    <rect x="70" y="14" width="6" height="16" rx="3" fill="#7a7f87" ${S}/>
  ...
  { cs: 'pátek', en: 'Friday', pattern: 'hrad (pátku)', gender: 'mi', topic: 'time', svg: `
    <rect x="6" y="22" width="108" height="72" rx="6" fill="#fff" ${S}/>
    <path d="M6 28 a6 6 0 0 1 6 -6 h96 a6 6 0 0 1 6 6 v6 H6 Z" fill="#4fa3e3" ${S}/>
    <rect x="34" y="14" width="6" height="16" rx="3" fill="#7a7f87" ${S}/>
    <rect x="70" y="14" width="6" height="16" rx="3" fill="#7a7f87" ${S}/>
  ...
  { cs: 'víkend', en: 'weekend', pattern: 'hrad', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'podzim', en: 'autumn', pattern: 'hrad', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'leden', en: 'January', pattern: 'hrad (ledna)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'únor', en: 'February', pattern: 'hrad (února)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'březen', en: 'March', pattern: 'hrad (března)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'duben', en: 'April', pattern: 'hrad (dubna)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'květen', en: 'May', pattern: 'hrad (května)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'červen', en: 'June', pattern: 'hrad (června)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'červenec', en: 'July', pattern: 'stroj (července)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'srpen', en: 'August', pattern: 'hrad (srpna)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'říjen', en: 'October', pattern: 'hrad (října)', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'listopad', en: 'November', pattern: 'hrad', gender: 'mi', topic: 'time', svg: `
  ...
  { cs: 'prosinec', en: 'December', pattern: 'stroj (prosince)', gender: 'mi', topic: 'time', svg: `
