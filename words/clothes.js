// Topic: clothes
WORDS.push(
  { cs: 'košile', en: 'shirt', pattern: 'růže', gender: 'f', level: 'A1', topic: 'clothes', svg: `
  ...
  { cs: 'bunda', en: 'jacket', pattern: 'žena', gender: 'f', level: 'A1', topic: 'clothes', svg: `
  ...
  { cs: 'sukně', en: 'skirt', pattern: 'růže', gender: 'f', level: 'A1', topic: 'clothes', svg: `
  ...
  { cs: 'čepice', en: 'cap, hat', pattern: 'růže', gender: 'f', level: 'A1', topic: 'clothes', svg: `
  ...
  { cs: 'bota', en: 'shoe', pattern: 'žena', gender: 'f', level: 'A1', topic: 'clothes', svg: `
  ...
  { cs: 'ponožka', en: 'sock', pattern: 'žena', gender: 'f', level: 'A1', topic: 'clothes', svg: `
  ...
  { cs: 'rukavice', en: 'glove', pattern: 'růže', gender: 'f', level: 'A1', topic: 'clothes', svg: `
  ...
  { cs: 'kalhoty', en: 'trousers', pattern: 'plural only', gender: 'f', level: 'A1', topic: 'clothes', svg: `
  ...
  { cs: 'barva', en: 'colour', pattern: 'žena', gender: 'f', level: 'A1', topic: 'clothes', svg: `
