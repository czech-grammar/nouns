...
WORDS.push(
  { cs: 'obličej', en: 'face', pattern: 'stroj', gender: 'mi', topic: 'body', svg: `
  ...
  { cs: 'nos', en: 'nose', pattern: 'hrad', gender: 'mi', topic: 'body', svg: `
  ...
  { cs: 'zub', en: 'tooth', pattern: 'hrad', gender: 'mi', topic: 'body', svg: `
  ...
  { cs: 'vlasy', en: 'hair', pattern: 'plural only (vlas, hrad)', gender: 'mi', topic: 'body', svg: `
  ...
  { cs: 'krk', en: 'neck, throat', pattern: 'hrad', gender: 'mi', topic: 'body', svg: `
  ...
  { cs: 'prst', en: 'finger, toe', pattern: 'hrad', gender: 'mi', topic: 'body', svg: `
  ...
  { cs: 'jazyk', en: 'tongue, language', pattern: 'hrad', gender: 'mi', topic: 'body', svg: `
  ...
  { cs: 'lék', en: 'medicine', pattern: 'hrad', gender: 'mi', topic: 'body', svg: `
