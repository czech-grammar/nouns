...
WORDS.push(
  { cs: 'žena', en: 'woman', pattern: 'žena', gender: 'f', topic: 'family', svg: `
  ...
  { cs: 'práce', en: 'work', pattern: 'růže', gender: 'f', topic: 'school', svg: `
  ...
  { cs: 'doba', en: 'time, era', pattern: 'žena', gender: 'f', topic: 'time', svg: `
  ...
  { cs: 'země', en: 'country, earth', pattern: 'růže', gender: 'f', topic: 'travel', svg: `
  ...
  { cs: 'věc', en: 'thing', pattern: 'kost', gender: 'f', topic: 'shopping', svg: `
  ...
  { cs: 'strana', en: 'side, page', pattern: 'žena', gender: 'f', topic: 'other', svg: `
  ...
  { cs: 'cesta', en: 'road, journey', pattern: 'žena', gender: 'f', topic: 'town', svg: `
  ...
  { cs: 'ruka', en: 'hand', pattern: 'žena', gender: 'f', topic: 'body', svg: `
  ...
  { cs: 'část', en: 'part', pattern: 'kost', gender: 'f', topic: 'other', svg: `
  ...
  { cs: 'otázka', en: 'question', pattern: 'žena', gender: 'f', topic: 'school', svg: `
  ...
  { cs: 'škola', en: 'school', pattern: 'žena', gender: 'f', topic: 'school', svg: `
  ...
  { cs: 'voda', en: 'water', pattern: 'žena', gender: 'f', topic: 'food', svg: `
  ...
  { cs: 'hlava', en: 'head', pattern: 'žena', gender: 'f', topic: 'body', svg: `
  ...
  { cs: 'noc', en: 'night', pattern: 'kost', gender: 'f', topic: 'time', svg: `
  ...
  { cs: 'chvíle', en: 'moment, while', pattern: 'růže', gender: 'f', topic: 'time', svg: `
  ...
  { cs: 'řeč', en: 'speech, language', pattern: 'kost', gender: 'f', topic: 'other', svg: `
  ...
  { cs: 'rodina', en: 'family', pattern: 'žena', gender: 'f', topic: 'family', svg: `
  ...
  { cs: 'společnost', en: 'society, company', pattern: 'kost', gender: 'f', topic: 'other', svg: `
    <g ${S}>
  ...
  { cs: 'válka', en: 'war', pattern: 'žena', gender: 'f', topic: 'other', svg: `
  ...
  { cs: 'kniha', en: 'book', pattern: 'žena', gender: 'f', topic: 'school', svg: `
